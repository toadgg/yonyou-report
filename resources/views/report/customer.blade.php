...
<script>
    $("#searchBtn").on('click', function(){
        $(this).closest('form').attr("action", "{{ route('report.customer', ['display' => 'default']) }}").submit();
    });
    ...
    $("#statisticsBtn").on('click', function(){
        $(this).closest('form').attr("action", "{{ route('report.customer.statistics', ['display' => 'statistics']) }}" ).submit();
    });
</script>
@endpush
