...
class XMSYFController extends Controller
{
    ...
    private function _createBuilder(array $query) {
        $_builder = DB::connection('oracle')->table('JZPM_PC_FACTBILLL_B')
            ...
            ->select('JZPM_PC_FACTBILL.VBILLNO', 'FDC_BD_PROJECT.VNAME', 'JZPM_PC_FACTBILL.DBUSIDATE', 'JZPM_PC_FACTBILLL_B.NFEEBASEMNY', 'JZPM_PC_FACTBILLL_B.VDEF1', 'JZPM_PC_FACTBILLL_B.VDEF2', 'JZPM_PC_FACTBILLL_B.VMOME')
